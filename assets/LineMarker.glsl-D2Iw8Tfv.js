import{wg as X,Hr as Z,Hs as ee,G2 as te,G0 as ie,Ht as re,Hu as ae,G7 as o,Hk as se,GG as oe,Hj as ne,G6 as w,Hv as ce,Hw as le,G3 as pe,G5 as de,G8 as he,H3 as ve,Ga as ue,Hx as A,Hy as F,Hz as me,HA as fe,GK as ge,f$ as Se,Gb as Pe,Gc as ye,_ as _e,Gd as G,Gf as N,Gg as we,Gh as R,Gi as L,GL as ze,Gk as xe,Gl as $e,Gn as be,Gj as Te,Go as V,HB as Ve,HC as E,HD as U,HE as ke,HF as Oe,HG as De,Gp as Ce,n as p,Gq as d,fY as We,GN as Ge,HH as I,qR as Le,Hb as Me,l4 as je,Gv as He,ce as B,cf as Y,yi as Ae,gx as q,HI as Fe}from"./index-B0e5FEUY.js";function J(r){const e=new X,{space:i,anchor:t,hasTip:P,hasScreenSizePerspective:z}=r,u=i===2,g=i===1;e.include(Z,r),e.include(ee,r),e.include(te,r);const{vertex:a,fragment:S,varyings:y}=e;ie(a,r),e.attributes.add("position","vec3"),e.attributes.add("previousDelta","vec4"),e.attributes.add("uv0","vec2"),y.add("vColor","vec4"),y.add("vpos","vec3",{invariant:!0}),y.add("vUV","vec2"),y.add("vSize","float"),P&&y.add("vLineWidth","float"),a.uniforms.add(new re("nearFar",({camera:l})=>l.nearFar),new ae("viewport",({camera:l})=>l.fullViewport)).code.add(o`vec4 projectAndScale(vec4 pos) {
